...
<div style="display: inline_block"><br>
  ...
  <img align="center" alt="trictv-PHP" height="30" width="40" src="https://raw.githubusercontent.com/devicons/devicon/master/icons/php/php-original.svg"/>
...
Olá! Meu nome é **Patrick Trindade** e sou de Catanduva - SP. 

<p align="justify">
  Sou formado em Gestão da Tecnologia da Informação e atuo profissionalmente como 🧑‍💼 <b>Desenvolvedor de Sistemas</b>. Tenho foco na entrega de soluções eficientes, qualidade de código e melhoria contínua de processos.
</p>

### 🚀 O que tenho feito ultimamente:
- 💻 Atuando no desenvolvimento e manutenção de sistemas ERP e Folha de Pagamentos corporativos.
- 📱 Focado na evolução e criação de aplicativos móveis nativos e multiplataforma (Kotlin, Xamarin Forms e .NET MAUI) voltados para gestão de setores, logística de cargas e força de vendas.
- ⚙️ Trabalhando diariamente com tecnologias como C#, VB.NET e SQL Server, acompanhando demandas ágeis através do Jira.
- 📚 Cursando Pós-Graduação em Programação para Dispositivos Móveis pela UTFPR para aprimorar ainda mais minhas entregas técnicas.

### ⚡ Perfil Profissional e Soft Skills:
- 💡 **Proatividade e Resolução de Problemas:** Sempre buscando aprender rapidamente e aplicar inovações nos projetos.
- 🤝 **Trabalho em Equipe:** Comunicação clara e colaboração constante em reuniões diárias de alinhamento.
- 🔄 **Flexibilidade e Organização:** Capacidade de adaptação em diferentes ambientes, desde a sustentação de sistemas legados até a criação de novas arquiteturas.
